...
'''
year = str(sys.argv[])
inputLocation = "EUWest2"
AWS_ACCESS_KEY_ID = "AKIAJC5JJR52ZTDNB2CQ"
AWS_SECRET_ACCESS_KEY = "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"
'''
year = str(sys.argv[1])
#year = input("Enter the year ")
AWS_ACCESS_KEY_ID = str(sys.argv[2])
AWS_SECRET_ACCESS_KEY = str(sys.argv[3])
inputLocation = str(sys.argv[4])
#AWS_ACCESS_KEY_ID = input("AWS_ACCESS_KEY_ID = ")
#AWS_SECRET_ACCESS_KEY = input("AWS_SECRET_ACCESS_KEY = ")
i#nputLocation = input("Bucket Location = ")
...
logger.info("Files for the 1st day are.. ")
...
logger.info("Reading the CSV files and appending it to  a Dataframe")
